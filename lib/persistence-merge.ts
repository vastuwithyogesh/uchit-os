...
const collectionKeys = [
  ...
  "orientationVersions",
  "d8OrientationSnapshots", "directionalInputVersions", "directionalEvaluationSnapshots", "directionalReportCardSnapshots", "directionalStageAPresentations",
  "openingMappings",
  ...
  "imageDerivatives",
  "imageProcessingBatches",
  "imageUtilityAuditEvents",
  "secureAccessGrants",
