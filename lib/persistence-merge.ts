...
const collectionKeys = [
  ...
  "stageBRemediations",
  "revisedLayoutCandidates",
  "remediationBaseLayoutVersions",
  "remedyRepositoryRecords",
  "remedyEligibilityResolutions",
  "reportPlacementPages",
  "physicalPlacements",
  "placementImplementationRows",
  "masterAppendixRows",
  "stageBIntegrityRuns",
  "sectionAWorkspaces",
  "sectionAVisualPages",
  "sectionAAssets",
  "existingLayoutAnnotations",
  "colourFrameCompositions",
  "sectionAIntegrityRuns",
  "remediationReportIntegrityRuns",
  "methodologyVersions",
  "methodologyRules",
