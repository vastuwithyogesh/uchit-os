...
test("operator runbooks preserve disposable-only boundaries and every activation blocker", async () => {
  ...
  for (const required of ["clean v1 through v11", "backup", "R2 inventory", "P5 professional boundaries", "P13 acceptance declaration", "P14 cancellation/refund/delay policy", "Statutory invoice", "Zoom/provider readiness", "Media Library activation", "Stage B remedial methodology"]) assert.match(hardening, new RegExp(required, "i"));
