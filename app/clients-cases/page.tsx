...
export default async function ClientsCasesPage() {
  ...
  return <main className="page-shell"><SiteHeader title="Clients & Cases" subtitle="Continue the next case or floor" /><ClientCasePipeline state={state} actor={access.actor} /></main>;
}
