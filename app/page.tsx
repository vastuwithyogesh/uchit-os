    ...
    <main className="page-shell">
      <header className="topbar">
        <div className="brand">
          ...
          <div>
            <div>Uchit Vastu</div>
            <div className="meta">CRM + evaluation engine</div>
          </div>
        </div>
      ...
      <section className="hero">
        <div className="hero-panel">
          ...
          <p className="lede">
            This build maps the PRD into a single operating surface for setters, consultants, admins, and super-admins. The demo keeps the full shape of the product visible: ScoreApp-style intake, ₹51,000 proposals, ₹11,000 minimum advances, floor workspace locking, utility evaluation, Shakti ranking, report approvals, WhatsApp templates, and a permanent client timeline.
          </p>
          <div className="hero-actions">
            <Link href="/crm" className="button">Open the CRM workbench</Link>
            <Link href="/timeline" className="button-secondary">Review the timeline</Link>
          </div>
        ...
        <aside className="hero-side">
          ...
          <div className="card">
            ...
            <p className="subtle">{currentUser.role} · {currentUser.email}</p>
      ...
      <section className="section-grid">
        ...
        <div className="card span-4">
          ...
          <h2>₹51,000 default proposal flow</h2>
